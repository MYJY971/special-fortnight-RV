...
struct Scene  
{
    ...
    Scene(bool includeIntensiveGPUobject = false) : num_models(0) 
    {
		...
		TriangleSet zozio;
		zozio.AddSolidColorBox(0.f, 0.f, 0.f, +1.f, +1.f, 1.f, 0xff501010);//Body
		zozio.AddSolidColorBox(2.f, 0.75f, 0.f, 1.01f, +1.f, 1.f, 0xffEC0008);//Left Wing
		zozio.AddSolidColorBox(-0.01f, 0.75f, 0.f, -1.f, +1.f, 1.f, 0xffEC0008);//Right Wing
		zozio.AddSolidColorBox(0.f, 0.75f, 1.f, 1.f, +1.f, 2.f, 0xffEC0008);//QUEUE
		zozio.AddSolidColorBox(0.25f, 0.25f, -0.50f, 0.75f, +1.f, 0.f, 0xffEC0008);//Head
		zozio.AddSolidColorBox(0.55f, 0.625f, -0.51f, 0.65f, 0.9f, -0.52f, 0xff000000);//Left eye
		zozio.AddSolidColorBox(0.35f, 0.625f, -0.51f, 0.45f, 0.9f, -0.52f, 0xff000000);//Right eye
		zozio.AddSolidColorBox(0.35f, 0.34f, -0.51f, 0.65f, 0.50f, -0.80f, 0xff804000);//Bec
		Add(new Model(&zozio, Vector3f(0, 0, 0), new Material(new Texture(false, Sizei(256, 256), Texture::AUTO_WHITE))));
		...
		for (int i = 0; i < 20; ++i)
		{
			...
			cloud.AddSolidColorBox(x, y, 0.f, x+3, y+2, 3.f, 0xff909090);
			cloud.AddSolidColorBox(x+3, y, 0.f, x+5, y+1, 3.f, 0xff909090);
			cloud.AddSolidColorBox(x-2, y, 0.f, x, y+1, 3.f, 0xff909090);

			/*cloud.AddSolidColorBox(6.f, 0.f, 0.f, 9.f, 2.f, 3.f, 0xff909090);
			cloud.AddSolidColorBox(9.f, 0.f, 0.f, 11.f, 1.f, 3.f, 0xff909090);
			cloud.AddSolidColorBox(4.f, 0.f, 0.f, 6.f, 1.f, 3.f, 0xff909090);*/
		}
		Add(new Model(&cloud, Vector3f(0, 0, 0), new Material(new Texture(false, Sizei(256, 256), Texture::AUTO_WHITE))));
        ...
        TriangleSet walls;
        /*walls.AddSolidColorBox(-10.1f, 0.0f, -20.0f, -10.0f, 4.0f, 20.0f, 0xffEC0008);  // Left Wall
		...
		walls.AddSolidColorBox(-200.1f, 0.0f, -200.0f, -200.0f, 50.0f, 200.0f, 0xff73F7E6);  // Left Wall
		walls.AddSolidColorBox(-200.0f, -0.1f, -200.1f, 200.0f, 50.f, -200.0f, 0xff73F7E6); // Back Wall
		walls.AddSolidColorBox(200.0f, -0.1f, -200.0f, 200.1f, 50.f, 200.0f, 0xff73F7E6);   // Right Wall
		walls.AddSolidColorBox(-200.0f, -0.1f, 200.1f, 200.0f, 50.f, 200.0f, 0xff73F7E6);   // Front Wall
		Add(new Model(&walls, Vector3f(0, 0, 0), new Material(new Texture(false, Sizei(256, 256), Texture::AUTO_WALL))));
        ...
        TriangleSet floors;
        floors.AddSolidColorBox(-200.0f, -0.1f, -200.0f, 200.0f, 0.0f, 200.1f, 0xff808080); // Main floor
        //floors.AddSolidColorBox(-15.0f, -6.1f, 18.0f, 15.0f, -6.0f, 30.0f, 0xffEC0008); // Bottom floor
        Add(new Model(&floors, Vector3f(0, 0, 0), new Material(new Texture(false, Sizei(256, 256), Texture::AUTO_WALL))));  // Floors

        TriangleSet ceiling;
        ceiling.AddSolidColorBox(-200.0f, 50.0f, -200.0f, 200.0f, 50.1f, 200.1f, 0xff73F7E6);
